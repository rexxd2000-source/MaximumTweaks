"""Hardware page — GPU, CPU, RAM tweaks with sub-tabs."""
...
_SUB_TABS = ["All", "CPU", "GPU", "RAM", "Performance"]


class HardwarePage(QWidget):
    """Hardware tweaks — GPU overclocking, CPU affinity, RAM, thermal management."""
    ...
    def __init__(self, ctx, navigate=None, parent=None):
        ...
        main.addWidget(PageHeader(
            "Hardware",
            "GPU overclocking/undervolting, CPU affinity, RAM management, and thermal tuning."))
    ...
    def _load_cards(self):
        ...
        tab_groups = {
            "All": ["cpu", "gpu", "ram", "performance"],
            "CPU": ["cpu"],
            "GPU": ["gpu"],
            "RAM": ["ram"],
            "Performance": ["performance"],
        }
        group_keys = tab_groups.get(self._current_tab, ["cpu", "gpu", "ram"])
        cats = set()
