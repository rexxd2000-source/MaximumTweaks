...
class DetectedGame:
    ...
    def state_color(self) -> str:
        colors = {
            GameState.NOT_INSTALLED: "#5F6178",
            GameState.NOT_RUNNING: "#5F6178",
            GameState.LAUNCHING: "#F0B54D",
            GameState.RUNNING: "#34d399",
            GameState.LOBBY: "#60a5fa",
            GameState.MATCHMAKING: "#fbbf24",
            GameState.IN_MATCH: "#34d399",
            GameState.NETWORK_ACTIVE: "#34d399",
            GameState.NETWORK_INACTIVE: "#F87979",
            GameState.UNKNOWN: "#5F6178",
        }
        return colors.get(self.game_state, "#5F6178")
